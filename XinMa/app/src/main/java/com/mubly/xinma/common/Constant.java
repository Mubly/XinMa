...
//    资产缩略图
    public static final String ASSET_HRADIMG_LITTLE_URL = URLConstant.BASE_IMG_URL + "Headimg/s/";

    //    资产清晰图
    public static final String ASSET_HRADIMG_BIG_URL = URLConstant.BASE_IMG_URL + "Headimg/b/";
//    模板缩略图
